...
senada = User.create(name: "Senada Kadric", user_name: "senada", description: "I'm a barbie girl, in a barbie world", age: 23, favorite_books: "Do no harm, When breath becomes air", location: "NYC", image_url: "https://i.pinimg.com/originals/31/33/ff/3133ff447d39045c7766a2a07e8d36b6.jpg")

bashir = User.create(name: "Bashir", user_name: "bashir2017", description: "I'm a barbie boy, in a barbie world", age: 28, favorite_books: "Ruby Docs, MDN", location: "NYC", image_url: "https://i.redd.it/y57kbzi3tmw41.jpg")
...
bookclub1 = Bookclub.create(name: "Do no harm club")
bookclub2 = Bookclub.create(name: "When breath becomes air is the best book of them all")
bookclub3 = Bookclub.create(name: "Mindfulness club")
bookclub4 = Bookclub.create(name: "The Stoics")
